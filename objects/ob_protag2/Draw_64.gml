...
draw_healthbar(xPos+5+string_width("HP: "),yPos - 3, xPos+85 + string_width("HP: "), yPos+15, (currHP/hp)*100, c_dkgray,c_red, c_green,0,true,true);//HP
